...
import { TypeWriter, CursorFollower } from "@/components";
  ...
  return (
    <>
      ...
      <Column maxWidth="m">
        ...
        <Flex fillWidth direction="row" gap="xl" horizontal="start">
          ...
          <Column className={styles.blockAlign} flex={1}>
            ...
            >
              ...
              >
                <TypeWriter texts={[person.role, "AI Engineer", "Machine Learning Specialist", "Backend Developer"]} speed={100} deleteSpeed={60} pauseTime={2500} />
              </Text>
              {social.length > 0 && (
